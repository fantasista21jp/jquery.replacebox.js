...
"replacebox-configs")}function s(){c.data(b.get(0),"replacebox-enabled",true);a.sortable===true&&b.sortable("option","disabled",false)}function t(){c.data(b.get(0),"replacebox-enabled",false);a.sortable===true&&b.sortable("option","disabled",true)}function v(){if(typeof a==="string")a=z();if(a!==null){b=c(b.selector);k=[];q()}}var w={appendTo:null,zIndex:999,handleUp:".up",handleDown:".down",handleOff:true,speed:500,easing:"swing",checkFunc:function(){return true},beforeFunc:null,afterFunc:null,sortable:false,
sortableOption:{},sortableCheckFunc:function(){return true},sortableBeforeFunc:null,sortableAfterFunc:null},b=this;if(typeof b!=="object"||b.length!==1)return this;var h,k=[];if(a){if(typeof a==="string"){if(a.match(/^_/))return this;try{eval(a)()}catch(A){"console"in window&&console.log(A)}return this}a=c.extend(w,a)}else a=w;c.data(b.get(0),"replacebox-position",false);if(!b.css("position")||b.css("position")=="static"){c.data(b.get(0),"replacebox-position",!b.css("position")?false:b.css("position"));
b.css("position","relative")}c.data(b.get(0),"replacebox-configs",a);t();q();return this}})(jQuery);
